...
public class SwaggerConfigProperties {
	...
	public SwaggerConfigProperties(String apiVersion, String enabled, String title, String description,
			String useDefaultResponseMessages, String enableUrlTemplating, String deepLinking,
			String defaultModelsExpandDepth, String defaultModelExpandDepth, String displayOperationId,
			String displayRequestDuration, String filter, String maxDisplayedTags, String showExtensions) {
		super();
		this.apiVersion = apiVersion;
		this.enabled = enabled;
		this.title = title;
